        ...
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col gap-5 h-full sm:group-even:ml-[18rem]">
          ...
          <div className="flex flex-wrap gap-2 ">
            <a
              href={liveUrl}
              target="_blank"
              className="flex gap-2 items-center justify-center dark:bg-white  bg-slate-700 text-slate-100 px-3 py-1 
                 uppercase  dark:text-black rounded-full "
            >
              <span>Live</span>
            ...
            <a
              href={codeUrl}
              target="_blank"
              className="group flex gap-2 items-center justify-center border-2  px-2 py-1 
                uppercase  text-black border-black dark:border-white rounded-full dark:text-white/70"
            >
              <span>Code</span>
